                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="invoice-cmp-ds ivc-frm">
                                        ...
                                        <div class="comp-tl">
                                            <h2>Nama Admin</h2>
                                            <p>Alamat Pelabuhan</p>
                                        </div>
                                        <br/>
                                        <div class="cmp-ph-em">
                                            <span>No Telfon Pelabuhan</span>
                                            <span>Fax Pelabuhan</span>
                                            <span>Email Pelabuhan</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="invoice-cmp-ds ivc-to">
                                        <div class="invoice-frm">
                                            <span>Pelabuhan Perikanan Nusantara Prigi</span>
                                        </div>
                                        <div class="comp-tl">
                                            <h2>Shafira Anggriati</h2>
                                            <p>Jalan Pantai Prigi, Desa Tasikmadu,</p>
                                            <p>Kec. Watulimo, Kabupaten Trenggalek</p>
                                        </div>
                                        <div class="cmp-ph-em">
                                            <span>(0355) 551147</span>
                                            <span>(0355) 551995</span>
                                            <span>ppnprigi@ymail.com</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
