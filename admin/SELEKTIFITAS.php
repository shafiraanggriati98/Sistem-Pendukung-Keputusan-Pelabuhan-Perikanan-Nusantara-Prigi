...
require'kode.php';
$selektifitas= query("SELECT * FROM SELEKTIFITAS");
$conn = mysqli_connect("localhost","root","","perikanan");
if(isset($_POST["submit"]))
{
if (tambah_selektifitas($_POST) > 0 )
  {
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>DATA SELEKTIFITAS TANGKAPAN IKAN PER ALAT TANGKAP</h2>
                    ...
                    <div class="data-table-list">
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                        <?php foreach ($selektifitas as $row) :
                                        ?>
                                        <tr>
                                          <td><?= $i; ?></td>
                                          <td><?= $row["NAMA_IKAN"];?></td>
                                                      ...
                                                      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                                          <div class="inbox-status">
                                                              <ul class="inbox-st-nav inbox-ft">
                                                                 <li><a href="UBAH_SELEKTIFITAS.php?id=<?= $row["id"]; ?>"><i class="notika-icon notika-draft"></i></a></li>
                                                             </ul>
                                                    </div>
                                                </div>
                                            </div>
