                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>DATA LOGIN ADMIN</h2>
                                        <p>REGISTRASI ADMIN<span class="bread-ntd"> BARU</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                      ...
                                                      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                                          <div class="inbox-status">
                                                              <ul class="inbox-st-nav inbox-ft">
                                                                 <li><a href="UBAH_ADMIN.php?id=<?= $row["id"]; ?>"><i class="notika-icon notika-draft"></i></a></li>
                                                             </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                 ...
                                                 <div class="inbox-area">
                                                    <div class="row">
                                                     <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                                             <div class="inbox-status">
                                                                  <ul class="inbox-st-nav inbox-ft">
                                                                  <li><a href="HAPUS_ADMIN.php?id=<?= $row["id"]; ?>"><i class="notika-icon notika-trash"></i></a></li>
                                                                  </ul>
                                                             </div>
                                                        </div>
                                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>Copyright © 2018 
. All rights reserved. Template by <a href="https://colorlib.com">SHAFIRA ANGGRIATI</a>.</p>
                    </div>
                </div>
            </div>
        </div>
