...
require'kode.php';
$tangkapan = query("SELECT * FROM hasil_tangkapan");
$conn = mysqli_connect("localhost","root","","perikanan");
if(isset($_POST["submit"]))
{
if (tambah_tangkapan($_POST) > 0 )
  {
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>DATA HASIL TANGKAPAN IKAN PER ALAT TANGKAP</h2>
                                    ...
                                    <?php $i = 1; ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                                      ...
                                                      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                                          <div class="inbox-status">
                                                              <ul class="inbox-st-nav inbox-ft">
                                                                 <li><a href="UBAH_TANGKAPAN.php?id=<?= $row["id"]; ?>"><i class="notika-icon notika-draft"></i></a></li>
                                                             </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <form method="post" action="" onclick= "return confirm('yakin?')">
                                                 <div class="inbox-area">
                                                    <div class="row">
                                                     <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                                             <div class="inbox-status">
                                                                  <ul class="inbox-st-nav inbox-ft">
                                                                  <li><a href="HAPUS_TANGKAPAN.php?id=<?= $row["id"]; ?>"><i class="notika-icon notika-trash"></i></a></li>
                                                                  </ul>
                                                             </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="panel-heading" role="tab">
                                                <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionGreen" href="#accordionGreen-three" aria-expanded="false">
                                                            TAMBAH DATA HASIL TANGKAPAN IKAN
                                                        </a>
                                                </h4>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="IKAN" placeholder="JENIS IKAN" required >
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="PANCING_TONDA" placeholder="PANCING TONDA">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="PUKAT_CINCIN" placeholder="PUKAT CINCIN">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="PANCING_ULUR" placeholder="PANCING ULUR">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="JARING_INSANG" placeholder="JARING INSANG">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="JUMLAH" placeholder="TOTAL" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int form-elet-mg res-mg-fcs">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" name="PAYANG" placeholder="PAYANG">
                                    </div>
                                    <div class="form-ic-cmp">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int form-elet-mg res-mg-fcs">
                                    ...
                                    <div class="nk-int-st">
                                        <button type="submit" name="submit" class="btn btn-success notika-btn-success">TAMBAHKAN DATA</button>
                                    </div>
                                    <div class="form-ic-cmp">
                                    </div>
                                </div>
