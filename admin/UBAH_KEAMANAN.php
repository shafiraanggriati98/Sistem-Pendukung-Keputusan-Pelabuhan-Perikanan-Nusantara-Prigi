...
$id = $_GET["id"];
$ubah = query("SELECT * FROM keamanan WHERE id = $id")[0];

if(isset($_POST["submit"]))
{
if (ubah_keamanan($_POST) > 0 )
  {

    echo "
      <script>
        alert('data berhasil diubah');
        document.location.href = 'KEAMANAN.php';
      </script>
     ";
    }
    else
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="accordion-wn-wp">
                        <div class="accordion-hd">
                            <h2>UBAH DATA KEAMANAN HASIL TANGKAPAN</h2>
                        </div>
                      </div>
                    </div>
                </div>
                    ...
                    <div class="form-element-list">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                      ...
                                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                 ...
                                                 <div class="nk-int-st">
                                                     <label >KEAMANAN AMAN = NELAYAN TIDAK PERLU TURUN MEMPERBAIKI JARING</label>
                                                </div>
                                                </div>
                                            </div>  
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                 ...
                                                 <div class="nk-int-st">
                                                     <label >NELAYAN TURUN DARI KAPAL UNTUK MEMPERBAIKI JARING</label>
                                                </div>
                                                </div>
                                            </div>  
                        </div>
