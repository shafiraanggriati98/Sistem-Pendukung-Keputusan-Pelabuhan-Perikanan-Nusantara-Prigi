...
require'kode.php';
$b_selek = query("SELECT * FROM bobot_selektifitas");
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>PEMBOBOTAN SELEKTIFITAS ALAT TANGKAP IKAN</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                      ...
                                                      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                                          <div class="inbox-status">
                                                              <ul class="inbox-st-nav inbox-ft">
                                                                 <li><a href="UBAH_BOBOTSELEKTIFITAS.php?id=<?= $row["id"]; ?>"><i class="notika-icon notika-draft"></i></a></li>
                                                             </ul>
                                                    </div>
                                                </div>
                                            </div>
